...
class DataIngestionConfig:
    ...
    def __init__(self,training_pipeline_config:TrainingPipelineConfig):
        try:
            self.database_name = "IOT_SENSOR_DATA"
            self.collection_name ="SMOKE_DATA"
...
class DataValidationConfig:
    def __init__(self,training_pipeline_config:TrainingPipelineConfig):
        try:
            ...
            self.base_file_path = os.path.join("smoke_detection_iot.csv")
...
class DataTransformationConfig:
    def __init__(self,traing_pipeline_config:TrainingPipelineConfig):
        try:
            self.data_transformation_dir = os.path.join(traing_pipeline_config.artifact_dir,"data_transformation")
...
class ModelTrainerConfig:
    def __init__(self,traing_pipeline_config:TrainingPipelineConfig):
        try:
            self.model_trainer_dir = os.path.join(traing_pipeline_config.artifact_dir,"model_tariner")
